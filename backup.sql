...
INSERT INTO `flgclass` VALUES ('AA',242,'Economy',69.00),('AA',242,'Extra',83.00),('AA',242,'First',182.00),('AA',2403,'Economy',69.00),('AA',2403,'Extra',83.00),('AA',2403,'First',182.00),('AA',2459,'Economy',66.00),('AA',2459,'First',174.00),('AA',2733,'Economy',63.00),('AA',2733,'First',166.00),('AA',2737,'Economy',66.00),('AA',2737,'Extra',79.00),('AA',2737,'First',174.00),('UA',589,'Economy',99.00),('UA',589,'First',261.00),('UA',589,'Plus',110.00),('UA',775,'Economy',50.00),('UA',775,'First',132.00),('UA',775,'Plus',50.00);
...
INSERT INTO `users` VALUES (1,'Lula Wiley','wiley@gmail.com','+1-202-555-0177','1',1),(2,'Isabell Horn','horn@gmail.com','+1-202-555-0136','1',1),(3,'Usman Hook','hook@hotmail.com','+1-219-555-0126','1',1),(4,'Abdullah Singleton','singleton@outlook.com','+1-404-555-0199','1',0),(5,'Sumaiya Dean','dean@yahoo.com','+1-512-555-0161','1',0),(6,'August Phillips','phillips@gmail.com','+1-213-555-0128','1',1),(7,'Student Test','test@mavs.uta.edu','+1-837-721-8965','1',1),(8,'Alexander S. Smith','AlexanderSSmith@airline.com','+1-818-617-5676','2',0),(9,'Dorothy J. Gregory','DorothyJGregory@airline.com','+1-360-302-4081','1',1),(10,'Theresa G. Hathaway','TheresaGHathaway@airline.com','+1-301-609-7990','2',0),(11,'Brandon A. Garcia','BrandonAGarcia@airline.us','+1-763-477-7105','3',0),(12,'Helen D. Cole','HelenDCole@airline.com','+1-407-685-8024','3',0),(13,'Iliana J. Manley','IlianaJManley@airline.com','+1-774-453-9545','2',0),(14,'Christal H. Rodriquez','CRodriquez@teleworm.us','+1-215-627-8663','1',1);
...
/*!50001 VIEW `viewticketinfo` AS select cast(`t`.`PurchaseDateTime` as date) AS `ticketPurchaseDate`,`t`.`TCKID` AS `ticketID`,if((`t`.`Type` = 1),'one-way','round trip') AS `ticketType`,`u`.`Name` AS `custName`,`u`.`Phone` AS `custPhone`,`s`.`FLGID` AS `flightID`,`s`.`TravelDate` AS `travelDate`,`s`.`CLASS` AS `flightClass`,concat('$',`t`.`TotalFare`) AS `flightFare` from ((`ticket` `t` join `users` `u` on((`t`.`USRID` = `u`.`USRID`))) join `sequence` `s` on((`t`.`TCKID` = `s`.`TCKID`))) order by cast(`t`.`PurchaseDateTime` as date) */;
...
-- Dump completed on 2020-05-03 18:48:28
